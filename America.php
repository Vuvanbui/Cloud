  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-3">
        ...
        <h1 class="my-4" style="color: gray"> Movie American</h1>
        <div class="list-group">
          <a href="Category.php" class="list-group-item " style="background-color: gray; color: white;">Movie odd</a>
          <a href="Ss.php" class="list-group-item sty" style="background-color: gray; color: white;">Series movie</a>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="Images/m.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">His Dark Materials</a>
                </h4>
                <h5>$24.99</h5>
                <p class="card-text" style="font-size: 75%">His Dark Materials is based on the best-selling novel of the same name by English writer Phillip Pullman. This literary masterpiece consists of 3 volumes: Northen Lights.</p>
            </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="Images/ae.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Arrow</a>
                </h4>
                <h5>$23</h5>
                <p class="card-text" style="font-size: 75%">Continuing the story After a serious shipwreck, the famous playboy billionaire of the city of Starling - Oliver Queen disappeared and had no hope of survival</p> 
              </div>
              <div class="card-footer"> 
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="Images/ccc.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
